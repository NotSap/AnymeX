    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          if (data.synonyms != null && data.synonyms!.isNotEmpty) ...[
            const SizedBox(height: 16),
            _buildScrollableChips(context, "Synonyms", data.synonyms!),
          ],
          if (data.tags != null && data.tags!.isNotEmpty) ...[
            const SizedBox(height: 16),
            _buildScrollableChips(context, "Tags", data.tags!, isTag: true),
          ],
          const SizedBox(height: 16),
